...
//FZ updated for substrate-validator
// added AccountIdLookup, OpaqueKeys to traits::
use sp_runtime::{
...
//fz ends
//Comented for substrate-validator-set
/*
use sp_runtime::{
	create_runtime_str, generic, impl_opaque_keys,
...
impl substrate_validator_set::Config for Runtime {
	...
	//type WeightInfo = substrate_validator_set::weights::SubstrateWeight<Runtime>;//commented because in logion
}
...
impl pallet_session::Config for Runtime {
	...
	//type WeightInfo = ();//commented because in logion
