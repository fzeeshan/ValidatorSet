//commented out below for substrate-validator-set
...
//OLDER CODE before substrate-validator-set change. fz
/*
fn testnet_genesis(
...
*/
//"keys": initial_authorities.iter().map(|x| (x.0.clone(),x.0.clone(),session_keys(x.1.clone(), x.2.clone()))).collect::<Vec<_>>(),